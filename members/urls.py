...
from .views import get_members_all, get_members_user, get_members_org, get_members_by_network, get_members_by_network_serializers
...
urlpatterns = [
    ...
    path('get_by_net_serial/<str:network_id>/', get_members_by_network_serializers, name='get_members_by_net_serializers'),
]
