    ...
    def model_release(self):
        ...
        try:
            ...
            if self.is_mqtt_online():
                ...
                text = format_html("<small style='color: green;'>{}<br />{} <img src='/static/admin/img/{}'><br />UP: {} - CPU: {}% - MEM: {}%</small>", model, second_line, is_rcall, get_uptime_string(uptime), load_15, memory_usage)
            else:
