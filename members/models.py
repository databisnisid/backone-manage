    ...
    def model_release(self):
        ...
        try:
            ...
            if self.is_mqtt_online():
                ...
                text = format_html("<small style='color: green;'>{}<br />{} <img src='/static/admin/img/{}'><br />{}<br />UP: {} - CPU: {}% - MEM: {}%</small>", model, second_line, is_rcall, uptime, get_string_betwee('up ', ', load', uptime), load_15, memory_usage)
            else:
