    ...
    def model_release(self):
        ...
        try:
            ...
            if self.is_mqtt_online():
                ...
                text = format_html("<small style='color: green;'>{}<br />{} <img src='/static/admin/img/{}'><br />{}<br />UP: {} - CPU: {:.1f}% - MEM: {:.1f}%</small>", model, second_line, is_rcall, uptime, get_uptime_string(uptime), load_15, memory_usage)
            else:
