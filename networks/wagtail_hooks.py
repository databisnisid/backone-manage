...
class NetworksPermissionHelper(PermissionHelper):
    ...
    def user_can_create(self, user):
        ...
        if user.is_superuser:
            ...
            total_networks = Networks.objects.filter(
...
class NetworksAdmin(ModelAdmin):
    ...
    def get_edit_handler(self):
        ...
        basic_panels = [
            ...
            MultiFieldPanel(
                [FieldPanel("ip_address_networks")], heading=_("IP Network")
            ),
        ]
        superuser_panels = [
            MultiFieldPanel(
            ...
            MultiFieldPanel([FieldPanel("user")], heading=_("Network Owner")),
        ]
...
class NetworkRoutesAdmin(ModelAdmin):
    ...
    panels = [
        MultiFieldPanel(
            [FieldPanel("ip_network"), FieldPanel("gateway")],
    ...
    def get_queryset(self, request):
        ...
        if not request.user.is_superuser:
            if current_user.organization.is_no_org:
                ...
                return NetworkRoutes.objects.filter(
                    organization=current_user.organization
                )
        else:
...
class NetworkRulesAdmin(ModelAdmin):
    ...
    panels = [
        MultiFieldPanel(
            [FieldPanel("network"), FieldPanel("rules_definition")],
    ...
    def get_queryset(self, request):
        ...
        if not current_user.is_superuser:
            if current_user.organization.is_no_org:
                ...
                return NetworkRules.objects.filter(
                    organization=current_user.organization
                )
        else:
